...
<section class="content">
            ...
            <div class="card card-primary">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="page-name" class="form-control" name="name_page" value="{{ old('name_page') }}">
                    </div>
                    <div class="form-group">
                        <label for="title_h1">Title H1</label>
                        <input type="text" id="title_h1" class="form-control" name="title_h1" value="{{ old('title_h1') }}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="meta_title" class="form-control" name="meta_title" value="{{ old('meta_title') }}">
                    </div>
                    <div class="form-group">
                        <label for="meta_description">Meta Description</label>
                        <input type="text" id="meta_description" class="form-control" name="meta_description" value="{{ old('meta_description') }}">
                    </div>
                    <div class="form-group">
                        <label for="meta_keyword">Meta Keyword</label>
                        <input type="text" id="meta_keyword" class="form-control" name="meta_keyword" value="{{ old('meta_keyword') }}">
                    </div>
                    <div class="row">
                        <div class="form-group" style="width: calc(100% / 5); margin-right: 10px;">
                            ...
                            <input type="file" hidden id="page-image" class="form-control" name="image" value="{{ old('image') }}" onchange="loadFileImage(this)">
    ...
    <div class="row">
        <div class="col-12">
            ...
            <input type="submit" value="Tạo mới Page" class="btn btn-success float-right">
        </div>
    </div>
</section>
