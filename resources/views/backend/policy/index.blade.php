                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="project-actions">
                            ...
                            <a class="btn btn-info btn-sm" href="{{ route('policy.edit', $value->id) }}">
                                <i class="fas fa-pencil-alt">
                                </i>
                                Edit
                            </a>
                            {{ Form::open(array('method'=>'DELETE', 'route' => array('policy.destroy', $value->id), 'style' => 'display: inline-block;')) }}
