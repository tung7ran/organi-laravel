            ...
            <div class="card card-primary">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="product_desc" class="form-control" rows="4" name="product_description" value="{{ old('product_description') }}"></textarea>
                    </div>
                    <div class="form-group">
                        <label for="product_img">Image</label>
                        <input type="file" id="product_img" class="form-control" name="product_image" value="{{ old('product_image') }}">
                    </div>
                </div>
                <!-- /.card-body -->
            </div>
