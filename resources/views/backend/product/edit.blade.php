                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea id="editor_desc" class="form-control" rows="4" name="desc">{{ $product->desc }}</textarea>
                                </div>
                            </div>
                            <div class="col-sm-9">
                                <div class="form-group">
                                    <label for="">Mô tả sản phẩm</label>
                                    <textarea id="editor_desc_product" class="form-control" rows="4" name="content">{{ $product->content }}</textarea>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="form-group">
            ...
            <div class="box box-success">
                ...
                <div class="box-body checkboxlist">
                    ...
                    @if (!empty($category))
                        ...
                        <div class="form-group">
                            <label>
                                <input type="checkbox" name="productCat_id" value="{{ old('$product->productCat_id', isset($item) ? 'checked' : '') }}"/><span>{{ $item->name }}</span>

                                <!-- <input name="productCat_id" type="checkbox" class="fomr-control" value="{{ $item->id }}" {{$product->productCat_id == $item->id ? 'selected' : '' }}><span>{{ $item->name }}</span> -->
                            </label>
                        </div>
                        @endforeach
                    @endif
